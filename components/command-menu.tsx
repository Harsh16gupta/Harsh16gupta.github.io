...
export function CommandMenu() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("toggle-command-menu", toggle)
        return () => {
            document.removeEventListener("keydown", down)
            window.removeEventListener("toggle-command-menu", toggle)
        }
    }, [])
        ...
        const down = (e: KeyboardEvent) => {
            ...
            if (e.shiftKey) {
                ...
                // Links
                    ...
                    e.preventDefault()
                    runCommand(() => openExternal("https://x.com/Harsh16Gupta"))
                } else if (key === 'l') {
                    e.preventDefault()
                    runCommand(() => openExternal("https://www.linkedin.com/in/harsh-gupta---/"))
                } else if (key === 'g') {
                    e.preventDefault()
                    // TODO: Replace with your GitHub profile URL if different
                    runCommand(() => openExternal("https://github.com/Harsh16gupta"))
                } else if (key === 'e') {
                    e.preventDefault()
            ...
            <CommandDialog open={open} onOpenChange={setOpen} className="font-custom2">
                ...
                <CommandList className="font-custom2 p-2">
                    ...
                    <CommandGroup heading="Links">
                        <CommandItem onSelect={() => runCommand(() => openExternal("https://x.com/Harsh16Gupta"))} className="rounded-lg py-3">
                        ...
                        <CommandItem onSelect={() => runCommand(() => openExternal("https://www.linkedin.com/in/harsh-gupta---/"))} className="rounded-lg py-3">
                        ...
                        <CommandItem onSelect={() => runCommand(() => openExternal("https://github.com/Harsh16gupta"))} className="rounded-lg py-3">
