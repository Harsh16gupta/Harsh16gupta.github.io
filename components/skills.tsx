    ...
    return (
        <div className="w-full mt-4 relative">
            ...
            <div className="flex flex-col items-start space-y-3">
                <h1 className="text-2xl sm:text-3xl font-bold font-custom tracking-tight text-neutral-900 dark:text-neutral-50 py-2">
                        ...
                        <div key={category.title} className="space-y-2.5">
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                                {category.skills.map((skill) => (
                                    <div
                                        key={skill.name}
                                        className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-1 sm:py-1.5 rounded-md bg-neutral-100 dark:bg-neutral-800/80 border border-neutral-200 dark:border-neutral-700/50 hover:border-neutral-300 dark:hover:border-neutral-600 transition-colors cursor-default"
                                    >
                                        <skill.icon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-neutral-600 dark:text-neutral-300" />
                                        <span className="text-[10px] sm:text-xs font-medium text-neutral-700 dark:text-neutral-200">
                                            {skill.name}
                                        </span>
                                    </div>
                                ))}
