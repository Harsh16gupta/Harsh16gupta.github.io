...
[![Live Site](https://img.shields.io/badge/Live-Portfolio-111111?style=for-the-badge&logo=vercel)](https://github.com/Harsh16gupta)
...
```bash
git clone https://github.com/Harsh16gupta/Portfolio.git
cd Portfoliov1
```
