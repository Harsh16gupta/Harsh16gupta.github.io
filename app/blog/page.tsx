...
export const metadata: Metadata = {
  title: "Blog | Harsh",
  description: "Thoughts on AI engineering, web development, and technology",
};
      ...
      <div className="max-w-4xl mx-auto ">
        ...
        <div className="mb-3">
          ...
          <p className="text-s text-neutral-600 dark:text-neutral-400 leading-relaxed mt-1 tracking-tight font-custom2 max-w-xl">
            {/* TODO: Customize your bio and profile details */}
            I am an AI engineer with a passion for building scalable
            and efficient systems. I love working with machine learning models, typescript, node, and databases.
          </p>
        </div>
